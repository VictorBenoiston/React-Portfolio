            ...
            <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto">
                ...
                <div className="flex justify-center items-center">
                    <form action="" className="flex flex-col w-full md:w-1/2">
                        <input required type="text" name="name" id="" placeholder="Enter your name"
                            className="p-2 bg-transparent border-2 rounded-md text-white
                    focus:outline-none"/>
                        <input required type="email" name="email" id="" placeholder="Enter your email"
                            className="p-2 bg-transparent border-2 rounded-md text-white
                ...
                rounded-md hover:scale-110 duration-300 hover:bg-gradient-to-bl">Let's Talk</button>
                    </form>
